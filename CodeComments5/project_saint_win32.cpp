 ...
 * Close the Window in a controlled manner
 *
 * ******    NOTE   ******************************************************** 
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch(message)
	{
		...
		case WM_CLOSE:
		{
                        ...
                        if (MessageBox(hwnd, "Really quit? All unsaved progress will be lost!", "Project_Saint", MB_OKCANCEL) == IDOK)
    			{
        			DestroyWindow(hwnd);
    			}
 ...
 * Closing the Window in a controlled manner
